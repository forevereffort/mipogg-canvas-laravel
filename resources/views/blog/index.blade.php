                    ...
                    @foreach($data['posts']['data'] as $post)
                        <div class="blog-item">
                            <div class="blog-featured-image">
                                ...
                                <img src="{{ $post['sthumbnail'] }}" alt="{{ $post['featured_image_caption'] }}"/>
                                @endif
                            </div>
                            <div class="blog-info">
                                ...
                                <div class="blog-info-link">
                                    <a href="{{ route('blog.post', $post['slug']) }}" id="blog-read-more-btn-{{ $post['id'] }}" data-post-id="{{ $post['id'] }}" class="blog-read-more-btn" data-status="no">Read more</a>
